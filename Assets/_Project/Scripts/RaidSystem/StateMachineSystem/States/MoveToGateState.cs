...
{
    public class MoveToGateState : BaseRaidState
    {
        #region Constructor

        public MoveToGateState(RaidInfo raidInfo, StateMachine stateMachine) : base(raidInfo, stateMachine)
        {
        ...
        {
            _path = HexPathFinder.Instance.FindPath(RaidInfo.CurrentCoordinate, RaidInfo.GateInfo.Coordinates)
                .ToArray();
